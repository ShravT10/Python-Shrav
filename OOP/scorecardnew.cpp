...
int main()
{
    ...
    cin>>date;
    ofile<<"\ndate: "<<date;
    ofile<<"\nSleep\tBf\tLunch\tDinner\tBonus\tWotah\tStudy\tGame\tTOTAL SCORE\n";
    ...
    cout<<ts<<"/35 !\n";
    ofile<<ss<<"\t"<<bfs<<"\t"<<lfs<<"\t"<<dfs<<"\t"<<ep<<"\t"<<ws<<"\t"<<sa<<"\t"<<gas<<"\t"<<ts;
    cout<<"YAYYYYY !!\n"<<"Your records have been saved in a file <3";
